# Phase 2a – IEC 61850 Reconnaissance and Circuit Breaker Operation on a Physical Siemens SIPROTEC 5 (Adaptive Hinting)
...
**OT Functional Verification – Autonomous IEC 61850 Reconnaissance and Circuit Breaker Operation (Phase 2a - Adaptive Hinting)**
